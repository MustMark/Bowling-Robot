...
if __name__ == '__main__':
    ...
    try:
        ...
        if 'red' in seen_colors and 'green' in seen_colors:
            run_with_retry("/home/ubuntu/Desktop/special/frame_two_special.py")
            GPIO.output(7, GPIO.HIGH)
            time.sleep(1)
            GPIO.output(7, GPIO.LOW)
            GPIO.cleanup()
        elif 'red' in seen_colors:
            run_with_retry("/home/ubuntu/Desktop/special/frame_three_special.py")
            GPIO.output(8, GPIO.HIGH)
            time.sleep(1)
            GPIO.output(8, GPIO.LOW)
            GPIO.cleanup()
        else:
            run_with_retry("/home/ubuntu/Desktop/special/frame_one_special.py")
            GPIO.output(24, GPIO.HIGH)
            time.sleep(1)
            GPIO.output(24, GPIO.LOW)
            GPIO.cleanup()
        ...
        stop(0)
        GPIO.cleanup()
        print("'controller_frame_special.py' ran successfully.")
